        ...
        const fullData = {
            ...
            'Waris': {
                ...
                details: [{
                    ...
                    {
                        name: '- Waris Berpindah Tangan',
                        target: 30000,
                        realisasi: 25000,
                        percentage: 83.3
                    },
                    {
                        name: '- Waris Anak Cucu',
                        target: 10000,
                        realisasi: 9000,
                        percentage: 90.0
                    }
        ...
        function updateTable(filterValue) {
            ...
            if (filterValue === 'all') {
                Object.keys(fullData).forEach(transType => {
                    const percentage = ((fullData[transType].realisasi / fullData[transType].target) * 100).toFixed(
                        1);
