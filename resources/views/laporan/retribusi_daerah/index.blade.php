...
@section('content')
    <div class="container">
        ...
        <div class="card mb-24">
            <div class="card-body">
                <div class="chart-header">
                    <p class="chart-title">Diagram Retribusi Daerah</p>
                    <div class="chart-controls">
                        <div class="filter-group">
                            <label class="filter-label">Filter:</label>
                            <select class="form-select form-select-sm" id="retributionFilter" onchange="filterData()">
                                <option value="all">Semua Jenis Retribusi</option>
                                <option value="Pelayanan Kesehatan">Pelayanan Kesehatan</option>
                                <option value="Pelayanan Persampahan">Pelayanan Persampahan</option>
                                <option value="Pelayanan Parkir">Pelayanan Parkir</option>
                                <option value="Pelayanan Pasar">Pelayanan Pasar</option>
                                <option value="Pengujian Kendaraan">Pengujian Kendaraan</option>
                            </select>
                        </div>
                ...
                <div class="chart-container">
                    <canvas id="retributionChart"></canvas>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="">
                <div class="accordion" id="retributionAccordion">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                <span class="fw-semibold">Detail Retribusi Daerah</span>
                            </button>
                        </h2>
                        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                            data-bs-parent="#retributionAccordion">
                            <div class="accordion-body mt-3">
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0" id="retributionTable">
                                        <thead>
                                            <tr>
                                                <th scope="col" class="fw-semibold">Jenis Retribusi</th>
        ...
        if (filterValue === 'all') {
            Object.keys(fullData).forEach(retType => {
                ...
                const categoryRow = `
                    <tr class="table-light">
                        ...
                        <td class="text-end">Rp ${fullData[retType].realisasi.toLocaleString('id-ID')}</td>
            ...
            const categoryRow = `
                <tr class="table-light">
                    ...
                    <td class="text-end">Rp ${retType.realisasi.toLocaleString('id-ID')}</td>
                    <td class="text-end">${percentage}%</td>
                </tr>
            `;
            tableBody.innerHTML += categoryRow;
