...
@section('title', 'Laporan - Penerimaan OPD')
    ...
    <script>
        ...
        const fullData = {
            'Dinas Pendidikan': {
                ...
                realisasi: 375000,
                details: [{
                        name: '- Retribusi Sekolah',
                        target: 180000,
                        realisasi: 165000,
                        percentage: 91.7
                    },
                    {
                        name: '- Sewa Gedung Sekolah',
                        target: 120000,
                        realisasi: 105000,
                        percentage: 87.5
                    },
            ...
            'Dinas Kesehatan': {
                ...
                realisasi: 335000,
                details: [{
                        name: '- Retribusi Rumah Sakit',
                        target: 180000,
                        realisasi: 165000,
                        percentage: 91.7
                    },
                    {
                        name: '- Retribusi Puskesmas',
                        target: 120000,
                        realisasi: 105000,
                        percentage: 87.5
                    },
                    {
                        name: '- Retribusi Ambulans',
                        target: 50000,
                        realisasi: 40000,
                        percentage: 80.0
                    },
            ...
            'Dinas Pekerjaan Umum': {
                ...
                details: [{
                    ...
                    {
                        name: '- Retribusi Penggunaan Jalan',
                        target: 100000,
                        realisasi: 88000,
                        percentage: 88.0
                    },
            ...
            'Dinas Pariwisata': {
                ...
                realisasi: 205000,
                details: [{
                        name: '- Retribusi Objek Wisata',
                        target: 130000,
                        realisasi: 115000,
                        percentage: 88.5
                    },
                    {
                        name: '- Retribusi Tempat Rekreasi',
                        target: 70000,
                        realisasi: 60000,
                        percentage: 85.7
                    },
        ...
        function filterData() {
            ...
            if (filterValue === 'all') {
                labels = ['Dinas Pendidikan', 'Dinas Kesehatan', 'Dinas Pekerjaan Umum', 'Dinas Perhubungan',
                    'Dinas Pariwisata'
                ];
                targetData = [
